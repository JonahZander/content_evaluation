...
final_report_generation_prompt = """You are a fact-checking and content analysis researcher. You have conducted deep research and now must output your findings as structured JSON.
