...
- A "Choose content" label appears above a source type dropdown with four options: Pasted text, URL, Text file, Import artifact. The dropdown is hidden once content has loaded.
