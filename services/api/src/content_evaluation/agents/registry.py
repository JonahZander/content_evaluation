...
_AGENTS: tuple[AgentDefinition, ...] = (
    ...
    AgentDefinition(
        agent_id="research",
        display_name="Targeted Research",
        description="Runs prompt-scoped follow-up research on an existing artifact and appends the findings.",
        category=AgentCategory.RESEARCH,
        depends_on=(),
        provider_kind=ProviderKind.DEEP_RESEARCH,
        execution_mode=AgentExecutionMode.MULTI_STEP,
        instruction_file="research.md",
        result_schema=FindingPayload,
        default_enabled=False,
        selectable=False,
    ),
