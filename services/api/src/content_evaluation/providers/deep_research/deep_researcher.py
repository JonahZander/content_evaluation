...
from content_evaluation.providers.deep_research.configuration import (
    Configuration,
)
...
from content_evaluation.providers.deep_research.state import (
    AgentInputState,
    AgentState,
    ClarifyWithUser,
    ConductResearch,
...
from content_evaluation.providers.deep_research.utils import (
...
async def researcher(state: ResearcherState, config: RunnableConfig) -> Command[Literal["researcher_tools"]]:
    ...
    mcp_prompt = getattr(configurable, "mcp_prompt", None) or ""
