...
from content_evaluation.providers.deep_research.configuration import Configuration, SearchAPI
from content_evaluation.providers.deep_research.prompts import summarize_webpage_prompt
from content_evaluation.providers.deep_research.state import ResearchComplete, Summary
...
async def get_all_tools(config: RunnableConfig):
    """Assemble toolkit with research and search tools (no MCP)."""
...
MODEL_TOKEN_LIMITS = {
    ...
    "openai:gpt-5.4-mini-2026-03-17": 400000,
    "openai:gpt-5.4-nano-2026-03-17": 400000,
...
def get_api_key_for_model(model_name: str, config: RunnableConfig):
    ...
    if should_get_from_config.lower() == "true":
        ...
        if model_name.startswith("openai:"):
            return os.getenv("OPENAI_API_KEY") or os.getenv("CONTENT_EVAL_OPENAI_API_KEY")
        elif model_name.startswith("anthropic:"):
            return os.getenv("ANTHROPIC_API_KEY") or os.getenv("CONTENT_EVAL_ANTHROPIC_API_KEY")
        elif model_name.startswith("google"):
            return os.getenv("GOOGLE_API_KEY") or os.getenv("CONTENT_EVAL_GOOGLE_API_KEY")
        return None
...
def get_tavily_api_key(config: RunnableConfig):
    ...
    if should_get_from_config.lower() == "true":
        ...
        return os.getenv("TAVILY_API_KEY") or os.getenv("CONTENT_EVAL_TAVILY_API_KEY")
